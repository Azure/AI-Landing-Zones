...
def define_env(env):
    @env.macro
    def latest_release(repo="Azure/AI-Landing-Zones"):
    ...
    @env.macro
    def latest_release_candidate(repo: str = "Azure/AI-Landing-Zones") -> str:
        rel = _get_latest_prerelease(repo)
        return (rel or {}).get("tag_name", "")

    @env.macro
    def latest_release_candidate_url(repo: str = "Azure/AI-Landing-Zones") -> str:
        rel = _get_latest_prerelease(repo)
